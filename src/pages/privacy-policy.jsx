...
style={{ backgroundImage: "url('/images/background.webp')" }}
    ...
    aria-hidden="true"
  ></div>
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 text-center ">Privacy Policy for Seasoned Fireworks</h1>
      <p className="mb-6  text-gray-500">Effective Date: 7/5/2025</p>
<div className=" mt-10 text-sm p-1 md:ml-40 ">
      ...
      <section className="mb-8">
        <h2 className=" font-semibold mb-2">3. Sharing Your Information</h2>
      ...
      <section className="mb-8">
        <h2 className=" font-semibold mb-2">4. Data Retention</h2>
      ...
      <section className="mb-8">
        <h2 className=" font-semibold mb-2">6. Security</h2>
